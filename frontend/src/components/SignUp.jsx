  ...
  return (
    <div className="signup-page-root">
      ...
      <Popup open={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <ol>
          <li>
            <strong>Acceptance of Terms</strong> — By accessing and using Flush,
          ...
          <li>
            <strong>Content Ownership</strong> — All content submitted by users
            remains the property of the user. By submitting content, you grant
            Flush a non-exclusive license to display and distribute it within
            the platform.
          </li>
          <li>
          ...
          <li>
            <strong>Modifications</strong> — Flush reserves the right to modify
          ...
          <li>
            <strong>Limitation of Liability</strong> — Flush is provided "as is"
            without warranties. We are not liable for any damages resulting from
